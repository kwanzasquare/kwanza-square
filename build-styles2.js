...
const source = fs.readFileSync(path.join(root, 'preview/styles2/src.js'), 'utf8');
...
if (!STYLES || !STYLES.length) {
  console.error('No styles found in preview/styles2/src.js — refusing to build an empty page.');
  process.exit(1);
}
...
fs.writeFileSync(path.join(root, 'preview/styles2/index.html'), page);
console.log('preview/styles2/index.html  ' + (page.length / 1024).toFixed(0) + ' KB  (static, no scripts)');
